...
function SearchByStyleBar() {
    ...
    function SearchEngineHanler(e) {
        ...
        if(!filteredAnimes) {
            ...
            let query = searchData.style || searchData.type || searchData.status || searchData.studio
            navigate(`/genres/${query}`, {state:filteredAnimes});        
        }
    }
